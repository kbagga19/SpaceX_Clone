$(document).ready(function(){
  ...
  const element = `<div class="individual-container"><a href="product.html">
  <img class="img1"  src="shop_image1.png" alt="error">`;
  ...
  filledContainer+= `<img  class="shop_image1" id="image-${index}" src="shop_image1_a.png" alt="error">`
